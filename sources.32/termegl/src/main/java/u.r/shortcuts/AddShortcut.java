...
import u.r.R;
import u.r.RemoteInterface;
import u.r.RunShortcut;
import u.r.TermDebug;
import u.r.compat.AlertDialogCompat;
import u.r.compat.PRNGFixes;
import u.r.util.ShortcutEncryption;
       ...
       extends    android.app.Activity
{
  ...
  void makeShortcut()
  {
              ...
              new View.OnClickListener()
              {
                public void onClick(View p1)
                {
                  ...
                  File get= (lastPath==null)
                    ...
                    {
                      pickerIntent.setClass(getApplicationContext(), u.r.shortcuts.FSNavigator.class)
    ...
    final ImageView img=new ImageView(context);
                    img.setImageResource(u.r.R.drawable.ic_launcher);
    ...
    )
    {
      ...
      Intent wrapper= new Intent();
             ...
             else
             {
               ...
               , Intent.ShortcutIconResource.fromContext(context, u.r.R.drawable.ic_launcher)
               );
             }
