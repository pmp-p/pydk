...
import u.r.compat.ActionBarCompat;
import u.r.compat.ActivityCompat;
import u.r.compat.AndroidCompat;
import u.r.compat.MenuItemCompat;
import u.r.emulatorview.EmulatorView;
import u.r.emulatorview.TermSession;
import u.r.emulatorview.UpdateCallback;
import u.r.emulatorview.compat.ClipboardManagerCompat;
import u.r.emulatorview.compat.ClipboardManagerCompatFactory;
import u.r.emulatorview.compat.KeycodeConstants;
...
public class Term extends Activity implements SurfaceHolder.Callback, UpdateCallback {
    ...
    protected void onStop() {
        super.onStop();
        Log.i(TermDebug.LOG_TAG, "onStop()");
        nativeOnStop();
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Log.i(TermDebug.LOG_TAG,"surfaceDestroyed(SurfaceHolder holder)");
...
/*================================================================================*/
    ...
    public static final String EXTRA_WINDOW_ID = "u.r.window_id";
    ...
    private static final String ACTION_PATH_BROADCAST = "u.r.broadcast.APPEND_TO_PATH";
    private static final String ACTION_PATH_PREPEND_BROADCAST = "u.r.broadcast.PREPEND_TO_PATH";
...
//PMPP
        ...
        Log.e(TermDebug.LOG_TAG," == GO FULLSCREEN ==");
        ...
        if (v != null) {
            ...
            Log.e(TermDebug.LOG_TAG," ======= HIDE SOFT ======= ");

            InputMethodManager imm = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);

            //FIXME: something removes softkbd , could be a problem
            ...
            Log.e(TermDebug.LOG_TAG," ======= NO VIEW ======= ");
        }
...
//!!
        ...
        //================
        Log.i(TermDebug.LOG_TAG, "onResume()");
        nativeOnResume();
    }
...
//!!
        ...
        //================
        Log.i(TermDebug.LOG_TAG, "onPause()");
        nativeOnPause();
    }
