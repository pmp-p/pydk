...
public final class RunShortcut extends RemoteInterface {
    public static final String ACTION_RUN_SHORTCUT = "u.r.RUN_SHORTCUT";

    public static final String EXTRA_WINDOW_HANDLE = "u.r.window_handle";
    public static final String EXTRA_SHORTCUT_COMMAND = "u.r.iShortcutCommand";
