...
public final class RunScript extends RemoteInterface {
    private static final String ACTION_RUN_SCRIPT = "u.r.RUN_SCRIPT";

    private static final String EXTRA_WINDOW_HANDLE = "u.r.window_handle";
    private static final String EXTRA_INITIAL_COMMAND = "u.r.iInitialCommand";
