...
NCURSES_BOOL 
# 118 "_27156.c"
extern  call_can_change_color (void);
 call_can_change_color (void)
{
...
NCURSES_BOOL 
# 336 "_27156.c"
extern  call_has_colors (void);
 call_has_colors (void)
{
...
NCURSES_BOOL 
# 470 "_27156.c"
extern  call_is_linetouched (WINDOW * a1, int z);
 call_is_linetouched (WINDOW * a1, int z)
{
...
NCURSES_BOOL 
# 476 "_27156.c"
extern  call_is_wintouched (WINDOW * z);
 call_is_wintouched (WINDOW * z)
{
...
NCURSES_BOOL 
# 1654 "_27156.c"
extern  call_is_cleared (const WINDOW * z);
 call_is_cleared (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1660 "_27156.c"
extern  call_is_idcok (const WINDOW * z);
 call_is_idcok (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1666 "_27156.c"
extern  call_is_idlok (const WINDOW * z);
 call_is_idlok (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1672 "_27156.c"
extern  call_is_immedok (const WINDOW * z);
 call_is_immedok (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1678 "_27156.c"
extern  call_is_keypad (const WINDOW * z);
 call_is_keypad (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1684 "_27156.c"
extern  call_is_leaveok (const WINDOW * z);
 call_is_leaveok (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1690 "_27156.c"
extern  call_is_nodelay (const WINDOW * z);
 call_is_nodelay (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1696 "_27156.c"
extern  call_is_notimeout (const WINDOW * z);
 call_is_notimeout (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1702 "_27156.c"
extern  call_is_pad (const WINDOW * z);
 call_is_pad (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1708 "_27156.c"
extern  call_is_scrollok (const WINDOW * z);
 call_is_scrollok (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1714 "_27156.c"
extern  call_is_subwin (const WINDOW * z);
 call_is_subwin (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1720 "_27156.c"
extern  call_is_syncok (const WINDOW * z);
 call_is_syncok (const WINDOW * z)
{
...
NCURSES_BOOL 
# 1763 "_27156.c"
extern  call_NCURSES_SP_NAME___can_change_color (SCREEN * z);
 call_NCURSES_SP_NAME___can_change_color (SCREEN * z)
{
...
NCURSES_BOOL 
# 1892 "_27156.c"
extern  call_NCURSES_SP_NAME___has_colors (SCREEN * z);
 call_NCURSES_SP_NAME___has_colors (SCREEN * z)
{
...
NCURSES_BOOL 
# 1900 "_27156.c"
extern  call_NCURSES_SP_NAME___has_ic (SCREEN * z);
 call_NCURSES_SP_NAME___has_ic (SCREEN * z)
{
...
NCURSES_BOOL 
# 1908 "_27156.c"
extern  call_NCURSES_SP_NAME___has_il (SCREEN * z);
 call_NCURSES_SP_NAME___has_il (SCREEN * z)
{
...
#if USE_SP_FUNC_SUPPORT
int NCURSES_SP_NAME(intrflush) (SCREEN * a1, WINDOW * a2, 
# 1932 "_27156.c" 3 4
 NCURSES_BOOL 
# 1932 "_27156.c"
 z)
...
NCURSES_BOOL 
# 1940 "_27156.c"
extern  call_NCURSES_SP_NAME___isendwin (SCREEN * z);
 call_NCURSES_SP_NAME___isendwin (SCREEN * z)
{
...
#if USE_SP_FUNC_SUPPORT
void NCURSES_SP_NAME(use_env) (SCREEN * a1, 
# 2302 "_27156.c" 3 4
 NCURSES_BOOL 
# 2302 "_27156.c"
 z)
...
#if USE_SP_FUNC_SUPPORT
void NCURSES_SP_NAME(use_tioctl) (SCREEN * a1, 
# 2311 "_27156.c" 3 4
 NCURSES_BOOL 
# 2311 "_27156.c"
 z)
...
NCURSES_BOOL 
# 2368 "_27156.c"
extern  call_NCURSES_SP_NAME___is_term_resized (SCREEN * a1, int a2, int z);
 call_NCURSES_SP_NAME___is_term_resized (SCREEN * a1, int a2, int z)
{
...
#if USE_EXT_SP_FUNC_SUPPORT
int NCURSES_SP_NAME(keyok) (SCREEN * a1, int a2, 
# 2384 "_27156.c" 3 4
 NCURSES_BOOL 
# 2384 "_27156.c"
 z)
...
int main(void)
{
 ...
 call_int attroff (0);
 call_# 41 "_27156.c" 3 4;
 call_ ((void *)0);
 call_# 41 "_27156.c";
 call_int attron (0);
 call_# 47 "_27156.c" 3 4;
 call_ ((void *)0);
 call_# 47 "_27156.c";
 call_int attrset (0);
 ...
 call_# 118 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 118 "_27156.c";
 call_ can_change_color ();
 call_int cbreak ();
 call_int chgat (a1, a2, a3,* 0);
 call_int clear ();
 call_int clearok (WINDOW * a1, ;
 call_# 142 "_27156.c" 3 4;
 call_ ;
 call_# 142 "_27156.c";
 call_ 0);
 call_int clrtobot ();
 ...
 call_# 336 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 336 "_27156.c";
 call_ has_colors ();
 call_# 342 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 342 "_27156.c";
 call_ has_ic ();
 call_# 348 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 348 "_27156.c";
 call_ has_il ();
 call_int hline (a1, 0);
 call_void idcok (WINDOW * a1, ;
 call_# 360 "_27156.c" 3 4;
 call_ ;
 call_# 360 "_27156.c";
 call_ 0);
 call_int idlok (WINDOW * a1, ;
 call_# 367 "_27156.c" 3 4;
 call_ ;
 call_# 367 "_27156.c";
 call_ 0);
 call_void immedok (WINDOW * a1, ;
 call_# 373 "_27156.c" 3 4;
 call_ ;
 call_# 373 "_27156.c";
 call_ 0);
 call_chtype inch ();
 ...
 call_int intrflush (WINDOW * a1, ;
 call_# 458 "_27156.c" 3 4;
 call_ ;
 call_# 458 "_27156.c";
 call_ 0);
 call_# 464 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 464 "_27156.c";
 call_ isendwin ();
 call_# 470 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 470 "_27156.c";
 call_ is_linetouched (WINDOW * a1, 0);
 call_# 476 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 476 "_27156.c";
 call_ is_wintouched (WINDOW * 0);
 call_const char * keyname (0);
 call_int keypad (WINDOW * a1, ;
 call_# 488 "_27156.c" 3 4;
 call_ ;
 call_# 488 "_27156.c";
 call_ 0);
 call_char killchar ();
 call_int leaveok (WINDOW * a1, ;
 call_# 500 "_27156.c" 3 4;
 call_ ;
 call_# 500 "_27156.c";
 call_ 0);
 call_char * longname ();
 call_int meta (WINDOW * a1, ;
 call_# 512 "_27156.c" 3 4;
 call_ ;
 call_# 512 "_27156.c";
 call_ 0);
 call_int move (a1, 0);
 ...
 call_int nl ();
 call_int nocbreak ();
 call_int nodelay (WINDOW * a1, ;
 call_# 818 "_27156.c" 3 4;
 call_ ;
 call_# 818 "_27156.c";
 call_ 0);
 call_int noecho ();
 ...
 call_void noqiflush ();
 call_int noraw ();
 call_int notimeout (WINDOW * a1, ;
 call_# 849 "_27156.c" 3 4;
 call_ ;
 call_# 849 "_27156.c";
 call_ 0);
 ...
 call_int scrollok (WINDOW * a1, ;
 call_# 982 "_27156.c" 3 4;
 call_ ;
 call_# 982 "_27156.c";
 call_ 0);
 ...
 call_int syncok (WINDOW * a1, ;
 call_# 1142 "_27156.c" 3 4;
 call_ ;
 call_# 1142 "_27156.c";
 call_ 0);
 ...
 call_void use_env (;
 call_# 1197 "_27156.c" 3 4;
 call_ ;
 call_# 1197 "_27156.c";
 call_ 0);
 call_void use_tioctl (;
 call_# 1204 "_27156.c" 3 4;
 call_ ;
 call_# 1204 "_27156.c";
 call_ 0);
 call_int vidattr (0);
 ...
 call_# 1285 "_27156.c" 3 4;
 call_ ((void *)0);
 call_# 1285 "_27156.c";
 call_int wattroff (WINDOW * a1, 0);
 call_# 1291 "_27156.c" 3 4;
 call_ ((void *)0);
 call_# 1291 "_27156.c";
 ...
 call_# 1654 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1654 "_27156.c";
 call_ is_cleared (WINDOW * 0);
 call_# 1660 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1660 "_27156.c";
 call_ is_idcok (WINDOW * 0);
 call_# 1666 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1666 "_27156.c";
 call_ is_idlok (WINDOW * 0);
 call_# 1672 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1672 "_27156.c";
 call_ is_immedok (WINDOW * 0);
 call_# 1678 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1678 "_27156.c";
 call_ is_keypad (WINDOW * 0);
 call_# 1684 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1684 "_27156.c";
 call_ is_leaveok (WINDOW * 0);
 call_# 1690 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1690 "_27156.c";
 call_ is_nodelay (WINDOW * 0);
 call_# 1696 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1696 "_27156.c";
 call_ is_notimeout (WINDOW * 0);
 call_# 1702 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1702 "_27156.c";
 call_ is_pad (WINDOW * 0);
 call_# 1708 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1708 "_27156.c";
 call_ is_scrollok (WINDOW * 0);
 call_# 1714 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1714 "_27156.c";
 call_ is_subwin (WINDOW * 0);
 call_# 1720 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1720 "_27156.c";
 call_ is_syncok (WINDOW * 0);
...
#endif
#if USE_SP_FUNC_SUPPORT
 call_# 1763 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1763 "_27156.c";
 call_ NCURSES_SP_NAME(can_change_color) (SCREEN * 0);
#endif
#if USE_SP_FUNC_SUPPORT
...
#endif
#if USE_SP_FUNC_SUPPORT
 call_# 1892 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1892 "_27156.c";
 call_ NCURSES_SP_NAME(has_colors) (SCREEN * 0);
#endif
#if USE_SP_FUNC_SUPPORT
 call_# 1900 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1900 "_27156.c";
 call_ NCURSES_SP_NAME(has_ic) (SCREEN * 0);
#endif
#if USE_SP_FUNC_SUPPORT
 call_# 1908 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1908 "_27156.c";
 call_ NCURSES_SP_NAME(has_il) (SCREEN * 0);
#endif
#if USE_SP_FUNC_SUPPORT
...
#endif
#if USE_SP_FUNC_SUPPORT
 call_int NCURSES_SP_NAME(intrflush) (SCREEN * a1, WINDOW * a2, ;
 call_# 1932 "_27156.c" 3 4;
 call_ ;
 call_# 1932 "_27156.c";
 call_ 0);
#endif
#if USE_SP_FUNC_SUPPORT
 call_# 1940 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1940 "_27156.c";
 call_ NCURSES_SP_NAME(isendwin) (SCREEN * 0);
#endif
#if USE_SP_FUNC_SUPPORT
...
#endif
#if USE_SP_FUNC_SUPPORT
 call_void NCURSES_SP_NAME(use_env) (SCREEN * a1, ;
 call_# 2302 "_27156.c" 3 4;
 call_ ;
 call_# 2302 "_27156.c";
 call_ 0);
#endif
#if USE_SP_FUNC_SUPPORT
 call_void NCURSES_SP_NAME(use_tioctl) (SCREEN * a1, ;
 call_# 2311 "_27156.c" 3 4;
 call_ ;
 call_# 2311 "_27156.c";
 call_ 0);
#endif
...
#endif
#if USE_EXT_SP_FUNC_SUPPORT
 call_# 2368 "_27156.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 2368 "_27156.c";
 call_ NCURSES_SP_NAME(is_term_resized) (SCREEN * a1, a2, 0);
#endif
#if USE_EXT_SP_FUNC_SUPPORT
 call_int NCURSES_SP_NAME(key_defined) (SCREEN * a1, char * 0);
#endif
#if USE_EXT_SP_FUNC_SUPPORT
 call_int NCURSES_SP_NAME(keyok) (SCREEN * a1, a2, ;
 call_# 2384 "_27156.c" 3 4;
 call_ ;
 call_# 2384 "_27156.c";
 call_ 0);
#endif
