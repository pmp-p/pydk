...
-DCMAKE_CURRENT_BINARY_DIR=CMAKE_INSTALL_BINDIR=${HOST}/bin -DCMAKE_INSTALL_INCLUDEDIR=${HOST}/include -DCMAKE_INSTALL_LIBDIR=${HOST}/lib \
-DCMAKE_INSTALL_BINDIR=${HOST}/bin -DPYTHON_EXECUTABLE=${HOST}/bin/python${PYMAJOR}.${PYMINOR} ${PANDA3D_CMAKE_ARGS}
